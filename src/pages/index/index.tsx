...
class Index extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      quyuChecked: '全部区域',
      swiperBanner: ['../../assets/img/expbj.jpg', '../../assets/img/expbj.jpg'],
      roomList: [
        // {
  ...
  init = async (res) => {
    ...
    const parmas = {
      districts: 'all', location: `${longitude},${latitude}`, page: 1, type: 1, per_page: 10
    }
  ...
  getRoomList = async (parmas = { districts: 'all', location: '116.483038,39.990633', page: 1, type: 1, per_page: 1 }, isMore = false) => {
    try {
    ...
    return (
      <ScrollView scrollY className='index' onScroll={this.handleScroll} onScrollToLower={this.getMore}  >
        ...
        <View className='index-header'>
          <Image className='index-header-banner' src={require('../../assets/img/expbj.jpg')}></Image>
          <View className='index-header-main'>
            <View className='index-header-info'>
              <View className='info-logo'>
                <Image className='info-logo-img' src={require('../../assets/img/header-logo.jpg')}></Image>
              </View>
            ...
            <Swiper
              ...
              <SwiperItem>
                <View className='swiper-item'>
                  <Image className='swiper-item-img' src={require('../../assets/img/expbj.jpg')}></Image>
                </View>
              </SwiperItem>
              <SwiperItem>
                <View className='swiper-item'>
